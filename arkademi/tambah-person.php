...
<html lang="en">
  ...
  <body class="app sidebar-mini rtl">
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-edit"></i>Tambah Data Person</h1>
          <p>Person</p>
        </div>
        <ul class="app-breadcrumb breadcrumb">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item">Form Person</li>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="tile">
            <h3 class="tile-title">Person</h3>
            <div class="tile-body">
              <form class="form-horizontal" method="post" action="p-add-person.php">
				...
				<div class="form-group row">
                  ...
                  <div class="col-md-7">
                    <input class="form-control col-md-12" type="datetime-local" name="create_at" value="<?=$data['create_at'];?>">
                  </div>
                </div>
